...
void KTAnimationspace::mousePressEvent(QMouseEvent *event)
{
    if (event->button () == Qt::RightButton)
        emit contextMenu(mapToGlobal(event->pos()));
}

void KTAnimationspace::mouseMoveEvent(QMouseEvent *event)
{
}

void KTAnimationspace::mouseReleaseEvent(QMouseEvent *event)
{
}

void KTAnimationspace::keyPressEvent(QKeyEvent *event) {
